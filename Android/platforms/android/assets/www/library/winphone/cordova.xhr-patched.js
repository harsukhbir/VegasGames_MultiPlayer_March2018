...
if (!docDomain || docDomain.length === 0) {
    ...
    var aliasXHR = win.XMLHttpRequest,
        fileSystemIsBusy = false,
        fileSystemCalls = [],
        doFileSystemCallAction = function() {
            
            if (fileSystemCalls.length == 0 || fileSystemIsBusy) {
                return;
            }
            
            fileSystemIsBusy = true;
            fileSystemCalls.pop()(function() {
                win.setTimeout(function() {
                    fileSystemIsBusy = false;
                    doFileSystemCallAction();
                }, 100);
            });
        };
        ...
        send: function (data) {
            if (this.wrappedXHR) {
                ...
                var gotFile = function (file) {
                    ...
                    alias.changeReadyState(this.OPENED);
                };

                var gotEntry = function (entry) {
                ...
                fileSystemCalls.push(function(callback) {
                    fileSystemWorkEndCallback = callback;
